...
function getCartSummary(items: CartDisplayItem[]): CartSummary {
...
function createCartItemMarkup(item: CartDisplayItem): string {
...
function createCartTableMarkup(
...
function createEmptyStateMarkup(message: string): string {
  return `
...
function createLoggedOutStateMarkup(): string {
  return `
...
function createCheckoutSuccessMarkup(): string {
  return `
